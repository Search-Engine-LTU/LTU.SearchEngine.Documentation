...
Given a set of linked URLs, Verify that the crawler starts from a seed URL and finds and visits all reachable web pages. 

\subsection*{Preconditions}
\begin{itemize}
  \item Crawler component is operational
  \item A search index surrogate is created and will store visited URL pages.
  \item The search index surrogate is initially empty.
  \item A source seed URL, with accompanied HTML page, and at least two additional HTML pages outside of, but linked by the seed URL. 
\end{itemize}
...
\begin{itemize}
  ...
  \item The search index surrogate contains entries from the seed URL page and all other linked pages.
\end{itemize}

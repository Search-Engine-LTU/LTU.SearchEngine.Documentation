...
component and that their textual contents are added to the search index.
...
\begin{itemize}
  ...
  \item At least one reachable PDF file exists and is allowed to be crawled.
  \item The search index is initially empty.
\end{itemize}

\subsection*{Test Data}
\begin{itemize}
  \item Seed URL: HTML page containing a link to \texttt{sample.pdf}
  \item PDF file contains known unique term: \texttt{``InformationRetrievalTestTerm''}
\end{itemize}
...
\begin{enumerate}
  \item Configure the crawler with the HTML page as the seed URL.
  \item Start the crawling process.
  \item Allow the crawler to fetch the HTML page and follow the link to the PDF file.
...
\subsection*{Expected Results}
\begin{itemize}
  \item The PDF file is successfully downloaded by the crawler.
  \item The indexing component extracts textual content from the PDF.
  \item Extracted terms are stored in the inverted index.
  \item A search for \texttt{``InformationRetrievalTestTerm''} returns the PDF document as a result.
  \item No errors occur during PDF parsing or indexing.
\end{itemize}
% ==========================================================

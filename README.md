...
- **A LaTeX engine:**
  ...
  - _Note: Restart VS Code after the installation!_
- **VS Code Extension:**
...
❌ DO NOT check in: .aux, .log, .pdf, .out, .bbl (These should be automatically ignored by .gitignore).

✅ ALWAYS check in: The .tex file (source code)

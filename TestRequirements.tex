...
FRQ-1013 & Domain-based crawling and rate limiting. \newline
...
FRQ-1014 & The crawler shall log the active rate limiting configuration values (\texttt{maxConcurrencyPerDomain}, \texttt{minDelayMs}) at startup for verification and debugging purposes. & \\
...
FRQ-3006 & Boolean OR Logic. The system shall support the disjunctive operator to match documents containing at least one specified term. \newline
Syntax: \newline
1. Keyword: OR (case-sensitive) \newline
2. Symbol: \texttt{||} \newline
3. Implicit: Whitespace between terms implies OR (Default behavior).& \\

FRQ-3009 & Boolean AND Logic. The system shall support the conjunctive operator to match documents containing all specified terms.
...
FRQ-3011 & Exclusion Logic (NOT). The system shall support operators to exclude documents containing specific terms. \newline
Syntax: \newline

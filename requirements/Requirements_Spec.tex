...
FRQ-1004 & The crawler shall log the active rate limiting configuration values (\texttt{maxConcurrencyPerDomain}, \texttt{minDelayMs}) 
  at startup for verification and debugging purposes. & TC-FRQ-1004\\
...
FRQ-3011 & Literal Search with Escaping. The system shall correctly interpret escaped characters as literal values within a query. &  TC-FRQ 3010 \\
